...
{
  //----------------------------------------------------------------------
  PredictionExtrap::PredictionExtrap(std::unique_ptr<IExtrap>&& extrap)
    : fExtrap(std::move(extrap))
  {
  }
  ...
  std::unique_ptr<PredictionExtrap> PredictionExtrap::LoadFrom(TDirectory* dir)
  {
    ...
    return std::unique_ptr<PredictionExtrap>(new PredictionExtrap(ana::LoadFrom<IExtrap>(dir->GetDirectory("extrap"))));
  }
}
